...
cap: frame drop monkeyreg_output_table
frame create monkeyreg_output_table b t ll ul F N `stats'     ///
					...
					* for each clustering choice
                    forv each_se = 1/`se_count' {	
	                    ...
	                    * save result to output table
                        frame post monkeyreg_output_table  ///
...
frame drop monkeyreg_output_table
end

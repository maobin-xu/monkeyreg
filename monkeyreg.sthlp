...
{pstd}
{cmd:monkeyreg} {hline 2} Plot and save regression results from specification combinations. Specification curve analysis, meta analysis, and robustness.{p_end}


{title:Syntax}

{phang2}{cmd:monkeyreg} , {opt dep(str)} {opt indep(str)} [{it:options}]{p_end}
